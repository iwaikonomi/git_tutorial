...
//		inquiry.setId(4);
//		inquiry.setName("hanako");
//		inquiry.setEmail("sample4@example.com");
//		inquiry.setContents("Herro");
//		
...
//    }
    ...
    public String upload(ImageForm imageForm, Model model) throws Exception {
        ...
        String base64 = new String(Base64.encodeBase64(imageForm.getImage().getBytes(), false),"ASCII");
        data.append("data:image/jpeg;base64,");
        data.append(base64);
        model.addAttribute("base64image",data.toString());
        return "inquiry/express";
    }
